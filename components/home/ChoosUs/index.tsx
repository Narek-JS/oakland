...
const ChoosUs = () => {
    ...
    return (
        <div className={classes.section}>
            <h2 className={classes.title}>Our friendly and knowledgeable experts guide you through the process of finding the perfect fit. Truck insurance gets complicated. We simplify it for you.</h2>
            <div className={classes.content}>
                <div className={classes.row}>
                    ...
                    <Image
                        alt="Choos us image"
                        src='/assets/images/Choosusimage.png'
                        width={380}
                        height={398}
                    />
                </div>
